...
public record Approval(
     ...
     * workflowId must be provided — generated by ApprovalWorkflow.create() before approvals are built.
     */
    public static Approval createPending(UUID id, ApprovalWorkflowId workflowId, String approverEmail) {
        return new Approval(id, workflowId, null, approverEmail, ApprovalStatus.PENDING,
                null, null, null);
    }
}
